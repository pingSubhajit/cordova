    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-between pb-3 bg-white">
            <div className="w-full h-[500px] relative flex flex-col items-center justify-center gap-6 p-16 text-center  text-white">
                {/* Background Pattern */}
                <img src={bg} alt="Background Pattern" className="absolute inset-0 w-full h-full object-cover" />
                ...
                {/* Title */}
                <h1 className="text-6xl font-bold z-10">Sort, effortlessly</h1>

                {/* Subtitle */}
                <p className="text-xl max-w-96 z-10">
           ...
           {/* Footer */}
           <div className="text-xs text-neutral-950 opacity-80 font-medium">
